...
impl XkbCompose {
    ...
    pub unsafe fn feed_keysym(&mut self, keysym: xkb_keysym_t) -> xkb_compose_feed_result {
        let result = (XKBCOMMON_COMPOSE_HANDLE.xkb_compose_state_feed)(self.compose_state, keysym);
    ...
    unsafe fn get_status(&mut self) -> xkb_compose_status {
        (XKBCOMMON_COMPOSE_HANDLE.xkb_compose_state_get_status)(self.compose_state)
    }

    pub unsafe fn get_keysym(&mut self) -> xkb_keysym_t {
